...
var webpack = _interopRequire(require("gulp-webpack-build"));
...
function provideTasks(gulp, rootDir) {
  ...
  gulp.task("webpack", ["build"], function () {
    var stream = gulp.src(path.join(tools, "webpack_config.js")).pipe(webpack.compile()).pipe(webpack.format({
      version: false,
      timings: true
  ...
  gulp.task("build-js", ["clean"], function () {
    return gulp.src("" + src + "/**/*.js").pipe(babel({ experimental: true })).pipe(gulp.dest(lib));
  });
